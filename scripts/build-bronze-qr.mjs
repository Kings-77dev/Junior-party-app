...
const reservationUrl = "https://mcvyral-reserve-staging.mcvyral.workers.dev/?package=bronze&utm_source=social&utm_campaign=bronze";
const width = 1080;
const height = 1350;
...
<svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="540" y="350" text-anchor="middle" fill="#FFFFFF" font-family="Helvetica Neue, Arial, sans-serif" font-size="64" font-weight="700" letter-spacing="3">BRONZE PACKAGE</text>
  <text x="540" y="404" text-anchor="middle" fill="#9DB1B6" font-family="Helvetica Neue, Arial, sans-serif" font-size="24" letter-spacing="5">SCAN TO RESERVE</text>
...
await sharp({ create: { width, height, channels: 4, background: "#17262D" } })
  ...
  .toFile("public/bronze-reserve-social.png");

await sharp(qr)
  .resize({ width: 1080, height: 1080, fit: "contain", background: "#FFFFFF" })
  .png({ compressionLevel: 9 })
  .toFile("public/bronze-reserve-qr.png");

console.log(`Bronze QR: ${reservationUrl}`);
